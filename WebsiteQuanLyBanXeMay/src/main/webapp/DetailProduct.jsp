...
<html>
	...
	<div class="jumbotron color-grey-light mt-70">
      <div class="d-flex align-items-center" style="margin-bottom: -20px; height: 30px; background-color: #fff ">
	    ...
	    <div class="container">
	      ...
	      <section class="mb-5">
	        ...
	        <div class="row" style="margin-top: 23px;
	          ...
	          <div class="col-md-6">
	            <h5>${detail.title}</h5>
	            <p style=" padding: 15px 20px; background: #fafafa; font-size: 30px;"><span class="mr-1"><strong>${giaTienGiam } VNĐ</strong></span><span
	            ...
	            <div class="table-responsive">
	              <table class="table table-sm table-borderless mb-0">
	                <tbody>
	                  ...
	                  <tr>
	                    <th class="pl-0 w-25" scope="row"><strong>Số Lượng có sẵn: </strong></th>
	      ...
	      <!-- Classic tabs -->
	      <div class="classic-tabs" style="margin-top: 23px;
								    background-color: #f2f2f2;
								    border-radius: 2%;
								    padding: 14px;">
	      ...
	      <hr>
	      <!--Section: Block Content-->
	      <section class="text-center" style="margin-top: 23px;
								    background-color: #f2f2f2;
								    border-radius: 2%;
								    padding: 14px;">
