		...
		<main>
		  ...
		  <div class="container pt-4" style="padding-left: 80px;">
		    ...
		    <section class="mb-4" style="margin-top:100px">
		      ...
		      <div class="card">
		        <div class="card-header py-3 row" style="margin: 0px;">
		        <div class="col-sm-6">
		          ...
		          <form action="xuatExcelControl" method="get"> 
		           <input oninput="searchByDate(this)" type="date" id="dateHoaDon" name="dateHoaDon" class="form-control mb-0" style="width:30%; margin-left: 130px;">
		           <button type="submit" class="mb-0 text-center btn btn-primary" style="margin-top: -50px;">Xuất file Excel</button> 
		            </form> 
		          </h5>
		          </div>
		        </div>
