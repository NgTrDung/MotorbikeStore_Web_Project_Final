...
<html lang="vi">
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="position: fixed; top: 0; width:100%;  z-index: 100000;">
	    <div class="container">
	        ...
	        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault" style="margin-right: -50px;">
...
<!-- 	                    <li class="nav-item">
	                    ...
	                    <li class="nav-item">
	                      <c:if test="${sessionScope.acc.username != \"admin\" }">
	                        	...
	                        	<a class="nav-link" href="EditProfile.jsp">XIN CHÀO, ${sessionScope.acc.hoTen}</a>
	                      </c:if>
	                      <c:if test="${sessionScope.acc.username == \"admin\" }">
